...
func (b Book) String() string {
	//s := fmt.Sprintf("Tile: %s by %s, %s. Released: %d, %s.", b.Title, b.Author.LastName, b.Author.FirstName, b.ReleaseYear, b.Distributor)
	s := ("Title: " + b.Title + " by " + b.Author.LastName + ", " + b.Author.FirstName + ". Released: " + strconv.Itoa(b.ReleaseYear) + ", " + b.Distributor + " Distribution.")
	return s
}
